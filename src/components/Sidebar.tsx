...
const navItems: NavItem[] = [
  {
    ...
    subItems: [
               ...
               { name: "Units Sold per SKU", path: "/unitSoldperSKU", pro: false },
  ...
  },
   {
    ...
    name: "Forecasting",
    subItems: [
               { name: "Sales Quantity Forecast", path: "/salesQuantityForecast", pro: false }, 
               { name: "Cashflow Forecast", path: "/cashFlowForecast", pro: false },
               { name: "Replenishment and Aging", path: "/stockReplenishmentForecast", pro: false },
              ],
    path: "/"
  },
  {
