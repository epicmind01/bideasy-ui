        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          <li>
            <DropdownItem
              tag="a"
              href="/profile"
              className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white w-full text-left"
            >
              <svg
                className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-200"
                width="20"
                height="20"
                viewBox="0 0 24 24"
                fill="none"
              ...
              >
                ...
                />
                <path
                  d="M12 14C8.685 14 6 16.685 6 20H18C18 16.685 15.315 14 12 14Z"
                  fill="currentColor"
                />
              </svg>
              My Profile
